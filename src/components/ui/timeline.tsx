    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-sm">
          A glimpse at the MVPs we've helped launch. Each one built in 21 days or less.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[hsl(var(--stat-purple))] via-[hsl(var(--stat-blue))] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
