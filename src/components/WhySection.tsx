...
const WhySection = () => {
  const traditionalPoints = ["Hire full engineering team", "3-6 months development time", "$100K+ upfront investment", "Technical debt and pivots"];
  const vrithLabsPoints = ["Startup-ready products in record time", "AI-driven, production-grade development", "Transparent, founder-first pricing", "Rapid iteration and support"];
  const features = [{
    icon: Target,
  ...
  return <section className="py-20 md:py-32 px-6 bg-secondary/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <div className="bg-card rounded-3xl p-8 md:p-10 border border-border">
            ...
            <ul className="space-y-4">
              {traditionalPoints.map((point, index) => <li key={index} className="flex items-start gap-3">
          ...
          <div className="bg-card-dark text-card-dark-foreground rounded-3xl p-8 md:p-10 relative overflow-hidden">
            ...
            <ul className="space-y-4">
              {vrithLabsPoints.map((point, index) => <li key={index} className="flex items-start gap-3">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => <div key={index} className="bg-card rounded-2xl p-6 border border-border hover-lift">
